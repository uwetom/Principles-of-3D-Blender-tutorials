...
You can see how to create your renders in the week 5 worksheet.

For the screen shot, we want to be able to see how you have constructed your model, therefore want to see a few things:

- The triangle count
	+ You can show this by turning on stats in the overlay menu
	+ ![Overlay menu](images/statistics.jpg)
...
- The textured mesh so that we can see how you have constructed your model
	+ Select all your objects and put it into edit mode so the mesh is visible.
...
![screen shot for submission](images/asubmission_screenshot.jpg)
