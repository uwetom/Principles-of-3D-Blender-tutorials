...
They combine text and videos, if you get stuck please ask for help. We all love making 3D content and are happy to share our knowledge.

You can also ask your neighbour for help as they may have faced the same issue as you.

Learning new software takes practice so please complete the challenges in these worksheets to improve your skills.
...
You can find Blender on UWE's software launcher "Apps Anywhere"
...
You can buy one from the Project Room (2Q20), I will bring some spare mice to class if you need one.

You **can** use a laptop trackpad but you will find it slower and more frustrating.

## 1. Interface

All 3D software packages share common interface elements, they can be in different locations and can be rearranged by the user.

![Blender main interface](images/panels_annotated.jpg)

- **3D viewport** - Your 3D scene
- **Outliner** -  A list of all objects in your scene (Meshes, lights, cameras etc..)
- **Properties** - View and modify information about the selected object and the whole scene

#### Saving

Remember to save your work often, it can be very frustrating to lose work in a crash.

- Save this new project by going to **file > save as**

This video walks you through the interface in more detail:
[<img alt="video showing the basic blender interface" src="images/video_1_interface.jpg">](https://uwe.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=80a2040a-d8e3-45c3-a3e8-b474009ba73d)
...
When you have an object selected in the viewport you can move, rotate and scale it. The shortcuts are:
...
![primitive mesh menu in Blender](images/add-mesh.jpg)
...
![Blender primitive options](images/primative_options.jpg)
...
Try to do this yourself before looking at my solution video below:
...
Click and drag objects to move them between collections.

- Rename the elements of your rocket, and group them together in a collection.

For a video walkthrough of this, watch this video:
...
## 7. Vertices, Faces and Edges

Primitive meshes are made up of multiple components - 

- Vertices (points)
- Edges (lines)
- Faces (polygons)

![vertices, edges and faces in blender](images/vertexedgeface.jpg)
...
In edit mode you can select and move the vertices, faces and edges by selecting them in the top menu:

![vertex, edge and face buttons in blender](images/vertex_edge_face.jpg)

You can also select these using the number row on your keyboard
...
- Practice moving individual edges, faces and vertices

This video shows this in more detail:
[<img alt="video showing how to manipulate vertices, edges and faces in Blender" src="images/video_7_vertexes.jpg">](https://uwe.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a81b9d35-2ad5-48ac-ac98-b47400bb54b8)

Tips:
- Double-click edges or faces to select whole loops.
- Hold **shift** to select multiple items.
- There are different ways to select multiple components, 
...
To find out how many triangles are in your model, turn on **Statistics** in the **Overlays** menu.

![statistics panel in Blender](images/statistics.jpg)

### Changing triangle count

When making new primitives, you can change the number of polygons
...
Choose **dissolve** if you do not want to make a hole.

This video shows you how to display the triangle count
...
We can add materials to whole objects, or individual faces by adding new materials in the **material property** area.
...
![change the colour of the material](images/colour_properties.jpg)

You can assign a material to the whole object, or only the selected faces in **Edit mode**.
...
- Think about which primitive shapes most closely resemble the parts of your vehicle.
...
We will cover more advanced modelling tools in future weeks, but here are some tips if you want to add more detail to your primitive shapes.
